...
USER_EMBED_PROGRAMS = neofetch credits desktop explorer narcpad settings snake core_tools
...
I386_TLS_TOOLS_BINARY = $(I386_OBJ_DIR)/user/bin/tls_tools
...
I386_TLS_TOOLS_SIZE = $(shell test -f $(I386_TLS_TOOLS_BINARY) && wc -c < $(I386_TLS_TOOLS_BINARY) || echo 0)
I386_TLS_TOOLS_SECTORS = $(shell test -f $(I386_TLS_TOOLS_BINARY) && echo $$(( ($$(wc -c < $(I386_TLS_TOOLS_BINARY)) + 511) / 512 )) || echo 0)
...
I386_TLS_TOOLS_LBA = $(shell echo $$(( $(I386_POSIX_SMOKE_LBA) + $(I386_POSIX_SMOKE_SECTORS) )))
I386_INITRD_END_LBA = $(shell echo $$(( $(I386_TLS_TOOLS_LBA) + $(I386_TLS_TOOLS_SECTORS) )))
...
I386_TLS_TOOLS_CFLAGS = -DNARCOS_DISK_TLS_TOOLS=1 -DNARCOS_DISK_TLS_TOOLS_LBA=$(I386_TLS_TOOLS_LBA) -DNARCOS_DISK_TLS_TOOLS_SIZE=$(I386_TLS_TOOLS_SIZE)
I386_DISK_PAYLOAD_CFLAGS = -DNARCOS_DISK_DOOM_BIN=1 -DNARCOS_DISK_DOOM_BIN_LBA=$(DOOM_BIN_LBA) -DNARCOS_DISK_DOOM_BIN_SIZE=$(I386_DOOM_BIN_SIZE) -DNARCOS_DISK_INITRD_LBA=$(DOOM_BIN_LBA) -DNARCOS_DISK_INITRD_SIZE=$(I386_INITRD_SIZE) -DNARCOS_DISK_INITRD_ADDR=0x00A00000 $(I386_DOOM1_WAD_CFLAGS) $(I386_POSIX_SMOKE_CFLAGS) $(I386_TLS_TOOLS_CFLAGS)
...
X86_64_TLS_TOOLS_BINARY = $(X86_64_OBJ_DIR)/user/bin/tls_tools
...
X86_64_TLS_TOOLS_SIZE = $(shell test -f $(X86_64_TLS_TOOLS_BINARY) && wc -c < $(X86_64_TLS_TOOLS_BINARY) || echo 0)
X86_64_TLS_TOOLS_SECTORS = $(shell test -f $(X86_64_TLS_TOOLS_BINARY) && echo $$(( ($$(wc -c < $(X86_64_TLS_TOOLS_BINARY)) + 511) / 512 )) || echo 0)
...
X86_64_TLS_TOOLS_LBA = $(shell echo $$(( $(X86_64_POSIX_SMOKE_LBA) + $(X86_64_POSIX_SMOKE_SECTORS) )))
X86_64_INITRD_END_LBA = $(shell echo $$(( $(X86_64_TLS_TOOLS_LBA) + $(X86_64_TLS_TOOLS_SECTORS) )))
...
$(I386_OBJ_DIR)/fs/fs.o: $(I386_DOOM_BINARY) $(I386_POSIX_SMOKE_BINARY) $(I386_TLS_TOOLS_BINARY) $(DOOM1_WAD)
...
$(I386_BOOT_MANIFEST_BIN): $(I386_KERNEL_ELF) $(I386_DOOM_BINARY) $(I386_TLS_TOOLS_BINARY) $(DOOM1_WAD) $(BOOT_MANIFEST_TOOL)
	@mkdir -p $(dir $@)
...
$(I386_IMAGE): $(I386_BOOT_BIN) $(I386_STAGE2_BIN) $(I386_BOOT_MANIFEST_BIN) $(I386_KERNEL_ELF) $(I386_USER_BINARIES) $(FS_SEED_TOOL)
	...
	dd if=$(I386_TLS_TOOLS_BINARY) of=$@ bs=512 seek=$(I386_TLS_TOOLS_LBA) conv=notrunc 2>/dev/null
...
$(X86_64_OBJ_DIR)/fs/fs.o: $(X86_64_DOOM_BINARY) $(X86_64_POSIX_SMOKE_BINARY) $(X86_64_TLS_TOOLS_BINARY) $(DOOM1_WAD)
...
$(X86_64_BOOT_MANIFEST_BIN): $(X86_64_KERNEL_ELF) $(X86_64_DOOM_BINARY) $(X86_64_TLS_TOOLS_BINARY) $(DOOM1_WAD) $(BOOT_MANIFEST_TOOL)
	@mkdir -p $(dir $@)
...
$(X86_64_IMAGE): $(X86_64_BOOT_BIN) $(X86_64_STAGE2_BIN) $(X86_64_BOOT_MANIFEST_BIN) $(X86_64_KERNEL_ELF) $(X86_64_USER_BINARIES) $(FS_SEED_TOOL)
	...
	dd if=$(X86_64_TLS_TOOLS_BINARY) of=$@ bs=512 seek=$(X86_64_TLS_TOOLS_LBA) conv=notrunc 2>/dev/null
